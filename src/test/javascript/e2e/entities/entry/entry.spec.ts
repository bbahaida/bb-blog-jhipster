...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/bbBlogApp.entry.home.title/);
    });

    it('should load create Entry page', () => {
        entryComponentsPage.clickOnCreateButton();
        entryUpdatePage = new EntryUpdatePage();
        expect(entryUpdatePage.getPageTitle()).toMatch(/bbBlogApp.entry.home.createOrEditLabel/);
